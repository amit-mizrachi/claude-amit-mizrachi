...
<A. LOCAL DEV STACK. Boot the stack against this worktree the way PLAN.md says to - the
dev-environment skill it names, or the boot command it gives. Wait for it to serve before testing - a stack that is still coming up
